...
<script type="text/javascript" >
	 ...
	 function del(boardNO) {
		 ...
		 if(chk) {
			 location.href='deleteArticle.do?boardNO=' + boardNO;
		 }
	 }
...
<body>
   <div class="main main-raised">
	...
	<div id="nickNameDrop"></div>
                        ...
                        <tr align="right">
                           <td colspan="2">
                              <c:if test="${member.id == board.id }">
                                    ...
                                    onClick="location.href='modArticle1.do?boardNO=${board.boardNO}'">
                                    <input class="btn btn-default btn-round" type=button value="삭제하기" onClick="del(${board.boardNO})">
                              </c:if>
               ...
               <jsp:include page="Pc_Board_ReplyList2.jsp"></jsp:include>
            </div>
         </div>
      </div>
   </div>
