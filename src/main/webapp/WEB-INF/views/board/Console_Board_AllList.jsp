...
<script>
	function fn_articleForm(isLogOn, articleForm, loginForm) {
		if(isLogOn != '' && isLogOn != 'false') {
			...
			location.href=loginForm+'?action=/board/ConsoleArticleForm.do';
		}	
	}
</script>
</head>
...
<body>
			...
			<div class="container">
				<div class="container" align="center">
					<div style="float: left;">
						<h2 class="title" align="left">Console Notice</h2>
						<h6 align="left">Console 플랫폼 게임 관련 내용만 작성해주세요.</h6>
					</div>
					<form id="searchForm"
						action="${contextPath}/board/Console_Board_AllList.do"
						method="get">
							...
							<nav class="navbar navbar-expand-lg bg-white"
								...
								<div class="container" align="center">
									...
									<input type='hidden' name='currentPageNo'
										...
										<input type='hidden' name='platform' value="${pagingCreatorDTO.pagingDTO.platform}">
									<button type="submit"
					...
					<table class="table" id="dataTable" style="align-content: center;">
						...
						<c:if test="${noticeList!=null}">
							<c:forEach var="notice" items="${noticeList}"
								varStatus="noticeNum">
								<tr align="center">
									<td colspan="2" style="color: blue; vertical-align: middle;">공지</td>
								...
								<c:when test="${boardList != null}">
									<c:forEach var="board" items="${boardList}"
										...
										<tr align="center">
											...
											<td width="5%" style="vertical-align: middle;">${board.platform}</td>
											<td align='left' width="35%" style="vertical-align: middle;">
												<span style="padding-right: 30px"></span> <a class='cls1'
												href="${contextPath}/board/ConsoleViewArticle.do?boardNO=${board.boardNO}">${board.title}</a>
											</td>
					...
					<div align="left" style="float: left;">
						<input class="btn btn-default btn-round" type="button" value="ALL"
							onclick="location.href='${contextPath}/board/Console_Board_AllList.do'">&nbsp;
						<input class="btn btn-default btn-round" type="button"
							value="XBOX"
							onclick="location.href='${contextPath}/board/Console_Board_AllList.do?platform=XBOX'">&nbsp;
						<input class="btn btn-default btn-round" type="button" value="PS4"
							onclick="location.href='${contextPath}/board/Console_Board_AllList.do?platform=PS4'">&nbsp;
						<input class="btn btn-default btn-round" type="button"
							value="SWITCH"
							onclick="location.href='${contextPath}/board/Console_Board_AllList.do?platform=SWITCH'">&nbsp;
					</div>
					<div align="right" style="float: right;">
						<button class="btn btn-primary btn-round"
							onclick="javascript:fn_articleForm('${isLogOn}','${contextPath}/board/ConsoleArticleForm.do','${contextPath}/member/loginForm.do')">
	...
	$(document).ready(function(){
	    ...
	    $(".paginate_button a").on("click", function(e){
	       ...
	       actionForm.attr("action", "${contextPath }/board/Console_Board_AllList.do");
	       actionForm.submit();
	    });
	 });
