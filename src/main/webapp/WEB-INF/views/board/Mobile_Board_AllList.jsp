  ...
  <script>
	function fn_articleForm(isLogOn, articleForm, loginForm) {
		if(isLogOn == '' || isLogOn == 'false') {
			...
			location.href=loginForm+'?action=/board/MobileArticleForm.do';
		}else {
      ...
      <div class="container">
         <div class="container" align="center">
            <div style="float: left;">
               <h2 class="title" align="left">Mobile Notice</h2>
               <h6 align="left">Mobile 플랫폼 게임 관련 내용만 작성해주세요.</h6>
            </div>
            <form id="searchForm"
               action="${contextPath}/board/Mobile_Board_AllList.do" method="get">
                        ...
                        <c:forEach var="board" items="${boardList}" varStatus="boardNum">
                           <tr align="center">
                              ...
                              <td align='left' width="35%" style="vertical-align: middle;">
                                 ...
                                 href="${contextPath}/board/MobileViewArticle.do?boardNO=${board.boardNO}">${board.title}</a>
                              </td>
            ...
            <div class="container" align="right">
               <button class="btn btn-primary btn-round"
                  onclick="javascript:fn_articleForm('${isLogOn}','${contextPath}/board/MobileArticleForm.do','${contextPath}/member/loginForm.do')">
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $(".paginate_button a").on("click", function(e){
	       ...
	       actionForm.attr("action", "${contextPath }/board/Mobile_Board_AllList.do");
	       actionForm.submit();
	    });
	 });
