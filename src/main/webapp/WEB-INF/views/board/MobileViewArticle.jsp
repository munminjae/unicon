...
<script type="text/javascript" >
	 ...
	 function MobileDel(boardNO) {
		 var chk = confirm("정말 삭제 할꺼니?");
		 if(chk) {
			 location.href='MobileDeleteArticle.do?boardNO=' + boardNO;
		 }
	 }
...
<body>
	...
	<div id="nickNameDrop"></div></h6>
                        ...
                        <tr align="right">
                           <td colspan="2">
                              <c:if test="${member.id == board.id }">
                                    ...
                                    onClick="location.href='MobileUpdateArticle1.do?boardNO=${board.boardNO}'">
                                    <input class="btn btn-default btn-round" type=button value="삭제하기" onClick="MobileDel(${board.boardNO})">
                              </c:if>
					...
					<jsp:include page="MobileReplyForm.jsp"></jsp:include>
					<jsp:include page="Mobile_Board_ReplyList.jsp"></jsp:include>
				</div>
	</div>
	</div>
	</div>
