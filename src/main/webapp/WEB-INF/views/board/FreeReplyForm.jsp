...
function backToList(obj){
 ...
 /* 댓글 등록하기(Ajax) */
 function fn_FreeReply(id) {
	 
	 if(id == null || id.length == "") {
		 alert("로그인 해주세요~")
		 location.href="${contextPath}/member/loginForm.do";
	 } else {
		 var form=document.frmFreeReply;
	     form.method="post";
	     form.action="${contextPath}/board/FreeAddReply.do";
	     form.submit();
	 }
 }
...
<body>
<div class="container">
      <form name="frmFreeReply" method="post"
         action="${contextPath}/board/FreeAddReply.do">
         <table class="table">
            <tr align="center">
