...
<script type="text/javascript">
	function backToList(obj) {
		obj.action = "${contextPath}/board/viewArticle2.do?boardNO=" + $
		{
			board.boardNO
		}
		;
	...
	function fn_modify_article(obj) {
		...
		if (title == null || title.length == "") {
			...
			obj.action = "${contextPath}/board/modArticle2.do";
			obj.submit();
		}
	}
</script>
		...
		<div class="section section-basic">
			<div class="container">
				<div class="container" align="center">
					<form name="frmMod" method="post"
						action="${contextPath}/board/modArticle2.do"
						...
						<input type=button value="수정반영하기" class="btn btn-primary btn-sm" style="font-size: medium;"
							onClick="fn_modify_article(frmMod)"> <input type=button class="btn btn-default btn-sm" style="font-size: medium;"
							value="취소" onClick="backToList(frmMod)">
					</form>
				</div>
				</div>
			</div>
