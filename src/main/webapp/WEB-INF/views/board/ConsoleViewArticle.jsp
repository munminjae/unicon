...
<script type="text/javascript" >
	 ...
	 function ConsoleDel(boardNO) {
		 var chk = confirm("정말 삭제 할꺼니?");
		 if(chk) {
			 location.href='ConsoleDeleteArticle.do?boardNO=' + boardNO;
		 }
	 }
...
<div class="main main-raised">
	...
	<div id="nickNameDrop"></div></h6>
                        ...
                        <tr align="right">
                           <td colspan="2">
                              <c:if test="${member.id == board.id }">
                                    ...
                                    onClick="location.href='ConsoleUpdateArticle1.do?boardNO=${board.boardNO}'">
                                    <input class="btn btn-default btn-round" type=button value="삭제하기" onClick="ConsoleDel(${board.boardNO})">
                              </c:if>
				...
				<jsp:include page="ConsoleReplyForm.jsp"></jsp:include>
 <jsp:include page="Console_Board_ReplyList.jsp"></jsp:include>
				</div>
	</div>
	</div>
	</div>
