...
<body>
	<div class="section section-signup page-header" style="color: #5F04B4; background-color: #5F04B4;">
		<div class="container">
			<div class="row">
					...
					<div class="card card-login">
						<form class="form" name="login">
							<div class="card-header card-header-default text-center">
								<h4 class="card-title" style="color: #27133B;">Management Login</h4>
							</div>
							<div class="card-body">
							...
							<div class="footer text-center">
								<input type="button" class="btn btn btn-primary col-md-4" value="로그인" onclick="loginProcess(this.form);"/>
								<input type="reset" class="btn btn btn-info col-md-4" value="초기화"/><br>
							</div>
						</form>
					</div>
				</div>
...
<script type="text/javascript">
	function loginProcess(obj) {
		...
		if (valueByPw == 'gmUniconTemp') {
			alert("초기 비밀번호 입니다. 변경해주세요");
			$('#myModal').modal("show");
		} else {
			obj.method = "post";
			obj.action = "${contextPath}/management/login.go";
			obj.submit();
		}
	}
