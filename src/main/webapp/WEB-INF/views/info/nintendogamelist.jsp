...
<head>
<meta charset="UTF-8">
<title>Nintendo 게임 목록창</title>
</head>
<body>
	<h1 align="center">Nintendo 게임 목록</h1>
		...
		<tr align="center">
			<form name="frmGameSearch" method="post" action="${contextPath}/info/gamesearch.do">
				<td>
					...
					<input type="hidden" name="genre" value="switch">
			...
			<td>
				<select id="genre" onchange="window.open(value,'_self');">
					...
					<option value="${contextPath}/info/psgamelist.do">PS</option>
					<option value="${contextPath}/info/nintendogamelist.do" selected>Nintendo</option>
				</select>
			</td>
		</tr>
		<tr>
	...
	<table border="1" align="center">
		<tr height="10" align="center" bgcolor="lightgreen">
			<td colspan="3">Nintendo 게임 목록</td>
		</tr>
		<c:choose>
			<c:when test="${nintendogameList == null}">
				<tr height="10">
					<td colspan="3">
						<p align="center">
		...
		<c:forEach var="nintendogame" items="${nintendogameList}">
			<tr align="left">
				<td><a href="${contextPath}/info/gameview.do?game_code=${nintendogame.game_code}">${nintendogame.game_name}</a></td>
				<td>
					장르 : ${nintendogame.genre}<br>
					플랫폼 : ${nintendogame.small_category}<br>
					배급사 : ${nintendogame.share_company}<br>
				</td>
				<td>
					<img src="${contextPath}/resources/image/logo/${nintendogame.game_code}.jpg" style="width:300px;"/>
				</td>
			</tr>
		</c:forEach>
	</table>
