...
<head>
<meta charset="UTF-8">
<title>Xbox 게임 목록창</title>
</head>
<body>
	<h1 align="center">Xbox 게임 목록</h1>
		...
		<tr align="center">
			<form name="frmGameSearch" method="post" action="${contextPath}/info/gamesearch.do">
				<td>
					...
					<input type="hidden" name="genre" value="xbox">
			...
			<td>
				<select id="genre" onchange="window.open(value,'_self');">
					...
					<option value="${contextPath}/info/xboxgamelist.do" selected>Xbox</option>
	...
	<table border="1" align="center">
		<tr height="10" align="center" bgcolor="lightgreen">
			<td colspan="3">Xbox 게임 목록</td>
		</tr>
		<c:choose>
			<c:when test="${xboxgameList == null}">
				<tr height="10">
					<td colspan="3">
						<p align="center">
		...
		<c:forEach var="xboxgame" items="${xboxgameList}">
			<tr align="left">
				<td><a href="${contextPath}/info/gameview.do?game_code=${xboxgame.game_code}">${xboxgame.game_name}</a></td>
				<td>
					장르 : ${xboxgame.genre}<br>
					플랫폼 : ${xboxgame.small_category}<br>
					배급사 : ${xboxgame.share_company}<br>
				</td>
				<td>
					<img src="${contextPath}/resources/image/logo/${xboxgame.game_code}.jpg" style="width:300px;"/>
				</td>
			</tr>
		</c:forEach>
	</table>
