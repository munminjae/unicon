...
<head>
<meta charset="UTF-8">
<title>Mobile 게임 목록창</title>
</head>
<body>
	<h1 align="center">Mobile 게임 목록</h1>
		...
		<tr align="center">
			<form name="frmGameSearch" method="post" action="${contextPath}/info/gamesearch.do">
				<td>
					...
					<input type="hidden" name="genre" value="mobile">
			...
			<td>
				<select id="genre" onchange="window.open(value,'_self');">
					...
					<option value="${contextPath}/info/mobilegamelist.do" selected>Mobile</option>
	...
	<table border="1" align="center">
		<tr height="10" align="center" bgcolor="lightgreen">
			<td colspan="3">Mobile 게임 목록</td>
		</tr>
		<c:choose>
			<c:when test="${mobilegameList == null}">
				<tr height="10">
					<td colspan="3">
						<p align="center">
		...
		<c:forEach var="mobilegame" items="${mobilegameList}">
			<tr align="left">
				<td><a href="${contextPath}/info/gameview.do?game_code=${mobilegame.game_code}">${mobilegame.game_name}</a></td>
				<td>
					장르 : ${mobilegame.genre}<br>
					플랫폼 : ${mobilegame.small_category}<br>
					배급사 : ${mobilegame.share_company}<br>
				</td>
				<td>
					<img src="${contextPath}/resources/image/logo/${mobilegame.game_code}.jpg" style="width:300px;"/>
				</td>
			</tr>
		</c:forEach>
	</table>
