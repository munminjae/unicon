...
<head>
	...
	<%-- <script src="${contextPath}/js/summernote/summernote-lite.js"></script>
	<script src="${contextPath}/js/summernote/lang/summernote-ko-KR.js"></script>
	...
	<script type="text/javascript">
			$(document).ready(function() {
				  $('#summernote').summernote({
			 	    	placeholder: '자유게시판에 등록할 내용을 작성해주세요',
				        minHeight: 620,
				        maxHeight: null,
				        focus: true, 
				        lang : 'ko-KR',
			...
			function freeAddArticle() {
				...
				if(title == null || title.length =="") {
					...
					form.method='post',
					form.action='${contextPath}/board/FreeAddArticle.do',
							...
							<table class="table" style="margin: auto;">
								...
								<tr>
									<td align="right"><input type="button"
										...
										value="글쓰기" onClick="freeAddArticle()" /> <input type="button"
