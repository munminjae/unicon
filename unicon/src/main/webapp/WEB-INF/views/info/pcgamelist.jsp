...
<head>
<meta charset="UTF-8">
<title>PC 게임 목록창</title>
</head>
<body>
	<h1 align="center">PC 게임 목록</h1>
		...
		<tr align="center">
			<form name="frmGameSearch" method="post" action="${contextPath}/info/gamesearch.do">
				<td>
					...
					<input type="hidden" name="genre" value="pc">
			...
			<td>
				<select id="genre" onchange="window.open(value,'_self');">
					...
					<option value="${contextPath}/info/pcgamelist.do" selected>PC</option>
	...
	<table border="1" align="center">
		<tr height="10" align="center" bgcolor="lightgreen">
			<td colspan="3">PC 게임 목록</td>
		</tr>
		<c:choose>
			<c:when test="${pcgameList == null}">
				<tr height="10">
					<td colspan="3">
						<p align="center">
		...
		<c:forEach var="pcgame" items="${pcgameList}">
			<tr align="left">
				<td><a href="${contextPath}/info/gameview.do?game_code=${pcgame.game_code}">${pcgame.game_name}</a></td>
				<td>
					장르 : ${pcgame.genre}<br>
					플랫폼 : ${pcgame.small_category}<br>
					배급사 : ${pcgame.share_company}<br>
				</td>
				<td>
					<img src="${contextPath}/resources/image/logo/${pcgame.game_code}.jpg" style="width:300px;"/>
				</td>
			</tr>
		</c:forEach>
	</table>
